package com.bhex.lib.uikit.widget.button;
...
public class RoundDrawable extends GradientDrawable {
    ...
    public static RoundDrawable fromAttributeSet(Context context, AttributeSet attrs) {
        ...
        int borderWidth = typedArray.getDimensionPixelSize(R.styleable.RoundButton_rb_borderWidth, ResUtils.getDimensionPixelSize(context,R.dimen.main_border_width));
        boolean isRadiusAdjustBounds = typedArray.getBoolean(R.styleable.RoundButton_rb_isRadiusAdjustBounds, false);
        int mRadius = typedArray.getDimensionPixelSize(R.styleable.RoundButton_rb_radius, ResUtils.getDimensionPixelSize(context,R.dimen.main_radius_conner));
